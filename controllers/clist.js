...
export const fetchList = async (req, res) => {
  ...
  const url = `https://clist.by/api/v1/contest/?username=rkas&api_key=2af8de4db93746d3d1ef7b60440c57b77943427b&resource__id__in=1,2,3,12,25,26,29,35,63,65,67,73,90,93,102,117,120&start__gte=${apiParam}&order_by=start&limit=300`;
  try {
